...
config_dataset = BaseDatasetConfig(
    formatter="ljspeech",
    dataset_name="wavs",
    path=f"{PATH}/ash_datasets",
    meta_file_train=f"{PATH}/ash_datasets/metadata.txt",
    language="ko",
)
...
SPEAKER_REFERENCE = [
    f"{PATH}/ash_datasets/wavs/2_audio.wav",  # speaker reference to be used in training test sentences
]
